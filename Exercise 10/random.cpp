...
double Random :: Exp(double lambda) {
   // This function generates a random number from an exponential distribution with given the lambda parameter
   return -1./lambda * log(1.-Rannyu());
}

double Random :: Lorentz(double mean, double gamma) {
   // This function generates a random number from a Cauchy-Lorentz distribution with given mean and gamma parameter
